...
def process_bed_files(positives_file, low_conf_pos1_file, low_conf_pos2_file, output_prefix):
...
def main():
    ...
    process_bed_files(args.positives_file, args.low_conf_pos1_file, args.low_conf_pos2_file, args.prefix)
