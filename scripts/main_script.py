...
def main():
    ...
    run_sampling_script(genes_without_pos_file=f"{args.output_prefix}_genes_without_pos.bed", genes_without_pos=f"{args.output_prefix}_genes_without_pos.fa", positives_file = f"{args.input_pos.split('.')[0]}.fa", positives_bed = f"{args.input_pos.split('.')[0]}.bed", input_low_conf1=args.input_low_conf1, input_low_conf2=args.input_low_conf2, num_samples=args.num_samples, output_prefix=args.output_prefix, sampling_mode=args.sampling_mode)
